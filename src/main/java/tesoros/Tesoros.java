...
public class Tesoros {
	...
	public Tesoros()
	{
		...
		//Caramelo caramelo16 = new Caramelo(50);
		//Caramelo caramelo17 = new Caramelo(50);
		//Caramelo caramelo18 = new Caramelo(50);
		//Caramelo caramelo19 = new Caramelo(50);
		//Caramelo caramelo20 = new Caramelo(50);
	...
	public Tesoro dropear()
	{
		...
		int posAleatoria = rand.nextInt(tesoros.size() - 1);//obtenemos una posicion entre 0 y el tamano del arreglo 
