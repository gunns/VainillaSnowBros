...
public class TrollRojoEnojado extends Mob {
	...
	public TrollRojoEnojado(Dimension dim, boolean playState, double velocity) {
		super(dim, playState, velocity, new AparienciaMob("mob4MueveDrc.png",
				"mob4MueveIzq.png", "mob4SaltoDrc.png", "mob4SaltoIzq.png",
				"mob4Baja.png", "mob4Muere.png"));
		...
		preparandoCorneadaDerecha = Sprite
				.fromImage("mob4PreparaCorneadaDrc.png");
		preparandoCorneadaIzquierda = Sprite
				.fromImage("mob4PreparaCorneadaIzq.png");
		this.volversePasivo();
	}
	...
	public void setPreparandoCorneadaIzquierda(
			Sprite preparandoCorneadaIzquierda) {
