...
public class Agresivo extends EstadoAgresividad{
	...
	public boolean isPersiguiendo() { return persiguiendo;}

	public void setPersiguiendo(boolean persiguiendo) {this.persiguiendo = persiguiendo;}

	public Integer getNumeroDeAccion() {return numeroDeAccion;}

	public void setNumeroDeAccion(Integer numeroDeAccion) {this.numeroDeAccion = numeroDeAccion;}
	 ...
	 *	6: izquierda
	 */
		if(this.numeroDeAccion == 1){this.moverArribaALaDerecha(deltaState);}
		if(this.numeroDeAccion == 2){this.moverArribaALaIzquierda(deltaState);}
		if(this.numeroDeAccion == 3){this.moverAbajoALaDerecha(deltaState);}
		if(this.numeroDeAccion == 4){this.moverAbajoALaIzquierda(deltaState);}
		if(this.numeroDeAccion == 5){this.moverseALaDerecha(deltaState);}
		if(this.numeroDeAccion == 6){this.moverseALaIzquierda(deltaState);}
	}	
}